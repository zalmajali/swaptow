...
export class SendpointPage implements OnInit {
  ...
  functionGoServices(catId:any,catName:any){
    this.router.navigate(['/services', {catId:catId,catName:catName}])
  }
