      ...
      await this.usersService.updateData(this.userId,this.catIdUser,this.subCatIdUser,this.cityId,this.regionId,this.userName,this.commercialName,this.serviceDetailsNew,this.typeWork).then(async data=>{
        ...
        if(this.operationResult==1){
          ...
          if(this.firstFileArray!=undefined && this.firstFileArray!=null && this.firstFileArray!=""){
            ...
            fileTransfer.upload(this.firstFileArray.uri, 'https://admin.eswapco.com/api/addImages/'+this.userId+"/1", options)
              .then((data) => {
              }, (err) => {
              })
          }
          if(this.secondFileArray!=undefined && this.secondFileArray!=null && this.secondFileArray!=""){
            ...
            fileTransfer.upload(this.secondFileArray.uri, 'https://admin.eswapco.com/api/addImages/'+this.userId+"/2", options)
              .then((data) => {
              }, (err) => {
              })
          }
          if(this.thirdFileArray!=undefined && this.firstFileArray!=null && this.thirdFileArray!=""){
            ...
            fileTransfer.upload(this.firstFileArray.uri, 'https://admin.eswapco.com/api/addImages/'+this.userId+"/3", options)
              .then((data) => {
              }, (err) => {
              })
          }
          if(this.foreFileArray!=undefined && this.foreFileArray!=null && this.foreFileArray!=""){
            let options: FileUploadOptions = {
              ...
              mimeType:this.foreFileArray.mediaType,
              chunkedMode:false,
              headers: {}
            }
            fileTransfer.upload(this.foreFileArray.uri, 'https://admin.eswapco.com/api/addImages/'+this.userId+"/4", options)
              .then((data) => {
              }, (err) => {
              })
          }
